...
_base_ = [
    "../../../../mmseg/configs/radio/radio_linear_8xb2-80k_ade20k-512x512.py"
]
...
model = dict(
    backbone=dict(
        ...
        patch_size=16,
        max_resolution=2048,
        preferred_resolution=dict(height=432, width=432),
        adaptor_cfgs=None,
...
# Checkpoint 'args' have amp=False and amp_dtype='float16' which is probably default amp settings
# Setting amp_dtype=bfloat16 so we don't change the dtype with --amp
amp_dtype = "bfloat16"
