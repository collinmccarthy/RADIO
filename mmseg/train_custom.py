...
def parse_args():
    ...
    parser.add_argument(
        ...
        "--test_out",
        type=str,
        help="Path for test results file as a pickle file",
    )
    parser.add_argument(
        "--test-out-item",
        "--test_out_item",
        type=str,
        help="Either 'pred' or None to save predictions, or 'metrics' to save result metrics",
    )
...
def main():
    ...
    # Modified: allow training or testing
    if args.train and not args.test:
        ...
        if args.test_out is not None and args.test_out_item == "metrics":
            mmengine.dump(metrics, args.test_out)
    else:
        raise RuntimeError("Must specify either --train or --test, and not both.")
